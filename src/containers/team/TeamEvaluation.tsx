...
import { AlwaysScrollToBottom, FormItem, Tabs, Toggle } from '@/components/elements';
import { Skeleton } from '@/containers/evaluate-personal';
import { EvaluationGroup } from '@/containers/evaluate-personal';
import { useAppDispatch, useAppSelector } from '@/hooks';
import { createEvaluationAsync, deleteEvaluationAsync, getEvaluationCandidateAsync, getMeAsync, getTeamDetailAsync, updateEvaluationAsync } from '@/redux/reducers';
...
const TeamEvaluationContainer = () => {
    ...
    const [candidateSelected, setCandidateSelected] = useState<IFormCandidateValue>(null)
    ...
    const handleGetDetailCTV = (candidateId: string) => {
        const candidate = teamReducer.members.find((candidate) => candidate._id === candidateId)
        if (!candidate) {
            return
        }
